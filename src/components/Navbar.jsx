        ...
        <div className="max-w-6xl mx-auto px-6 h-16 sm:h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button
              ...
              className="bg-secondary text-white px-5 py-2 rounded-full border-2 border-fg font-bold text-sm shadow-pop flex items-center gap-2 hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_0px_var(--color-fg)] active:translate-x-[2px] active:translate-y-[2px] active:shadow-[2px_2px_0px_0px_var(--color-fg)] transition-all cursor-pointer"
            >
              联系
